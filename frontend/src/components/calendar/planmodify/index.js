...
const PlanModify = () => {
  ...
  useEffect(() => {
    ...
    async function getMonthlySchedule() {
      ...
      setState({
        completed: result.data.is_finished,
  ...
  const modify = async () => {
    if(window.confirm("정말 변경하실 껀가요?")){
      let started_at = moment(
        `${moment().format(
          "YYYY"
        )}-${startMonth}-${startDay} ${startHour}:${startMin}`
      ).format("YYYY-MM-DD HH:mm");
      let finished_at = moment(
        `${moment().format("YYYY")}-${endMonth}-${endDay} ${endHour}:${endMin}`
      ).format("YYYY-MM-DD HH:mm");
      await scheduleAPI
        .modifySchedule(
          id,
          ...
          state.alarmYES,
          started_at,
          moment(data.deadline_at).format("YYYY-MM-DD HH:mm"),
          finished_at
        )
        .then(({data}) => {
    ...
    <Wrapper>
      ...
      <form>
        ...
        <Grid
          ...
          direction="column"
          style={{ padding: "25px", height: "670px", width: "100%" }}
        >
          <Grid
            container
            direction="row"
          ...
          >
            ...
            >
              <Grid style={{ marginTop: "3px" }}>시작일</Grid>
            </Grid>
            <Grid
              container
              direction="row"
          ...
          >
            ...
            {/* checkbox */}
            <Grid
              style={{ marginLeft: "50px", width: "380px", marginTop: "3px" }}
            >
              <FormGroup row>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={state.alarmCheck}
          ...
          >
            ...
            {/* checkbox */}
            <Grid
              style={{ width: "380px", marginLeft: "50px", marginTop: "3px" }}
            >
              <FormGroup row>
                <FormControlLabel
                  control={
          ...
          >
            ...
            >
              <WbIncandescentIcon
                style={{ color: "#A3CCA3", marginRight: "20px" }}
              />
              <div
              ...
              <div style={{ marginRight: "20px" }}>{noise}</div>
              <OpacityIcon
                style={{
                  color: "#A3CCA3",
                  marginRight: "20px",
              ...
              />
              <div style={{ marginRight: "20px" }}>{humi}</div>
              <Thermometer style={{ color: "#A3CCA3", marginRight: "20px" }} />
              <div style={{ marginRight: "20px" }}>{temp}</div>
            </Grid>
          </Grid>
        </Grid>
        {/* footer */}
        ...
        >
          ...
          <Button
            type="submit"
            variant="contained"
            style={{ background: "#A3CCA3", color: "#FFFFFF" }}
            onClick={modify}
          >
            수정하기
          </Button>
...
>>>>>>> 75d8c1cc70d0c735b2384c095469c5c383cb4c50
};
